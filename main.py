...
def parse_args():
    ...
    p.add_argument("--model",  choices=["resnet18", "densenet100", "resnet50", "mobilenet"], default='densenet100')
    p.add_argument("--ckpt", help="Model checkpoint path",default='/home/sgchr/Documents/cosine_layers/runs/densenet100_cif10/best.pth')
...
def main():
    ...
    if "cosine_layers" in methods:
        ...
        calib_loader = make_calib_loader(args.id, id_train_tf, args.cos_calib_per_class, args.data_root)
